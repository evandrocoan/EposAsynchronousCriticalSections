...
Closure< ReturnType(Tn ...) > create_closure( ReturnType(*_entry)( Tn ... ), Tn ... an )
{
    ...
    LOG( Debug, WRN, "create_closure " << closure << endl )
    return *closure;
}
...
void test_closure_with_return(Tn ... an) {
    ...
    LOG( Debug, WRN, "    " << return_value << endl << endl )
}

char test_function1(char arg1, int arg2, bool arg3) {
    LOG( Debug, WRN, "test_function1 " << arg1 << ", " <<  arg2 << ", " << arg3 << endl )
    return 'A';
}

char test_function2(const char* arg1, const char* arg2, char arg3) {
    LOG( Debug, WRN, "test_function2 " << arg1 << ", " <<  arg2 << ", " << arg3 << endl )
    return 'B';
}

char test_function3() {
    LOG( Debug, WRN, "test_function3 " << endl )
    return 'C';
}

void test_function4() {
    LOG( Debug, WRN, "test_function4 " << endl )
}

void test_function5(const char* arg1) {
    LOG( Debug, WRN, "test_function5 " << arg1 << endl )
}
