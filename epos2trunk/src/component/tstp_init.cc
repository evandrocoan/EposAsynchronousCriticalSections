...
//    else
    ...
    //else if(!memcmp(Machine::id(), "\x00\x4b\x12\x00\xe2\xaf\x0d\x06", 8)) // Water flow sensor 2
    //    _here = Coordinates(-6000,4500,0);
    // UFSC HU mesh 2
    //if(!memcmp(Machine::id(), "\x00\x4b\x12\x00\xfb\x39\x3a\x06", 8)) { // Sink
    //    _here = TSTP::sink();
    //    TSTP::coordinates(Global_Coordinates(74495693, 694506043, 25300));
    //}
    //else if(!memcmp(Machine::id(), "\x00\x4b\x12\x00\xbd\x83\x0d\x06", 8)) // Water flow sensor 1
    //    _here = Coordinates(6400,-4800,0);
    //else if(!memcmp(Machine::id(), "\x00\x4b\x12\x00\x6a\x82\x0d\x06", 8)) // Water flow sensor 2
    ...
    //} else {
    //    // Student's room 1
    //    if(!memcmp(Machine::id(), "\x00\x4b\x12\x00\x1a\x83\x0d\x06", 8)) // Lights 0
